package keno.guildedparties.api.client.screens.own_guild.management.rank;
...
public class RankManagementMenu extends BaseUIModelScreen<FlowLayout> {
    ...
    public RankManagementMenu(String guildName, List<Rank> ranks) {
        super(FlowLayout.class, DataSource.asset(GuildedParties.modLoc("rank_management_ui")));
    ...
    protected void build(FlowLayout flowLayout) {
        ...
        flowLayout.childById(ButtonComponent.class, "back")
                .onPress(button -> GPNetworking.GP_CHANNEL.clientHandle().send(new NoParamServerPacket("guild", NoParamServerPacket.GET_OWN_GUILD)));
