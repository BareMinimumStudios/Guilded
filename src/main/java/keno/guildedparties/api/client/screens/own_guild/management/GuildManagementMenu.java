package keno.guildedparties.api.client.screens.own_guild.management;

import io.wispforest.owo.ui.base.BaseUIModelScreen;
import io.wispforest.owo.ui.component.ButtonComponent;
import io.wispforest.owo.ui.container.FlowLayout;
import keno.guildedparties.GuildedParties;
import keno.guildedparties.api.client.screens.own_guild.management.leadership.LeadershipMenu;
import keno.guildedparties.api.client.screens.own_guild.management.rank.RankManagementMenu;
...
public class GuildManagementMenu extends BaseUIModelScreen<FlowLayout> {
    ...
    public GuildManagementMenu(String guildName, Map<String, Rank> players, List<Rank> ranks, String description) {
        super(FlowLayout.class, DataSource.asset(GuildedParties.modLoc("guild_management_ui")));
