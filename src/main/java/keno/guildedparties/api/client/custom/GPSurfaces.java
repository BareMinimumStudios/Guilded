package keno.guildedparties.api.client.custom;
...
public class GPSurfaces {
    public static Surface createCustomSurface(Identifier surface) {
        return (context, component) -> drawPanel(surface, context, component.x(), component.y(), component.width(), component.height());
    }
